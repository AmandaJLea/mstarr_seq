...
# for f in `cat 1Nov2019Novaseq.txt`; do cat process1.sh | sed -e s/FILEINFO/$f/g > process1.${f}.sh; done
# rm commands1.sh; touch commands1.sh
# for f in `cat 1Nov2019Novaseq.txt` ; do echo 'sh process1.'$f'.sh' >> commands1.sh; done
...
# set paths
f2=FILEINFO
R1=/Genomics/ayroleslab2/alea/archive_raw_fastq/from_RAJ_mSTARR/1Nov2019Novaseq/${f2}_R1_001.fastq.gz
R2=/Genomics/ayroleslab2/alea/archive_raw_fastq/from_RAJ_mSTARR/1Nov2019Novaseq/${f2}_R2_001.fastq.gz
